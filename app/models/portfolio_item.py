...
class PortfolioItem(Base):
    ...
    item_type: Mapped[PortfolioItemType] = mapped_column(SQLAlchemyEnum(PortfolioItemType), nullable=False)
    status: Mapped[PortfolioItemStatus] = mapped_column(SQLAlchemyEnum(PortfolioItemStatus), nullable=False, default=PortfolioItemStatus.PENDING)
