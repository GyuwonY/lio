...
- **입력된 content를 분석하여 핵심 역량 기반의 주제를 추출합니다. 만약 여러 프로젝트나 이슈가 동일한 역량(예: 성능 최적화, DB 설계, 아키텍처 개선 등)을 보여준다면, 이를 '하나의 핵심 주제'로 그룹화하여 질문을 구성하는 것을 권장합니다.**
- **명확한 공통점이 없는 경험은 개별 프로젝트를 각각의 주제로 다룹니다.**
